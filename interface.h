...
typedef enum
{
	...
	CF = 'FC',
#endif
	ST = 'TS',  ///< порог для разности крайних точек АЧХ (DL, DE)
	...
	SA = 'AS',
	HT = 'TH',
	ES = 'SE',  ///< вкл/выкл режима поиска. Полезно при измерении АЧХ датчика
	LN = 'NL',  ///< длина выборки, по которой строится АЧХ
	DS = 'SD',   ///< порог для разности (DE-DL)
	FL = 'LF'   ///< порог потери захвата
}Cmd_t;
